...
R code and results for evaluating UDPipe's pretrained english-ewt model
on formal (UD_English-EWT test split) vs. informal (Tweebank v2 test split) text,
as part of a research poster examination (Trends in Natural Language Processing,
1. Parallelgruppe, Universität Trier).
